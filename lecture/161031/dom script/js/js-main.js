...
(function(global){
  ...
  createModalWindow = function() {
    createDim();
    createModal();
	var remove_dim = function(){
		document.querySelector(".dim").parentNode.removeChild(document.querySelector(".dim"));
	}
    document.querySelector(".modal-close-button").onclick = remove_dim;
    document.querySelector(".dim").onclick = remove_dim;
  ...
  createModal = function() {
    ...
    document.querySelector('.dim').appendChild(container);
    console.log('modal-window:', document.querySelector('.modal-window'));
    document.querySelector('.modal-window').appendChild(headline);
    document.querySelector('.modal-window').appendChild(paragraph);
	document.querySelector('.modal-window').appendChild(button);
  };
  // modal 윈도우 레이어 생성
...
function createEl(element_name) {
	...
	return document.createElemnet(element_name)
}
...
console.log(issues);
var issues_count=issues.length, issue;
